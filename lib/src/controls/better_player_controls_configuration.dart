...
class BetterPlayerControlsConfiguration {
  ...
  // Skip Back Icon Size - Added by Vrushank
  final double skipBackIconSize;

  ///Cupertino only icon, icon of forward
  final IconData skipForwardIcon;

  // Skip Forward Icon Size - Added by Vrushank
  final double skipForwardIconSize;

  // Replay Button Icon Size - Added by Vrushank
  final double replayButtonIconSize;
  ...
  const BetterPlayerControlsConfiguration({
    ...
    this.skipBackIconSize,
    this.skipForwardIcon = Icons.fast_forward,
    this.skipForwardIconSize,
    this.replayButtonIconSize,
